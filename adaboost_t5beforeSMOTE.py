...
accuracy = cross_val_score(best_adaboost, X, y, cv=kf, scoring='accuracy')
precision = cross_val_score(best_adaboost, X, y, cv=kf, scoring='precision_macro')
recall = cross_val_score(best_adaboost, X, y, cv=kf, scoring='recall_macro')
f1 = cross_val_score(best_adaboost, X, y, cv=kf, scoring='f1_macro')
