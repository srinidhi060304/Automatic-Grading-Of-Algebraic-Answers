...
# Load the data
data = pd.read_excel(r'D:\srinidhi\amrita\out of context\out of context\resampled_t5_embeddings.xlsx')
...
cv_accuracy = cross_val_score(best_knn, X, y, cv=5, scoring='accuracy')
cv_precision = cross_val_score(best_knn, X, y, cv=5, scoring='precision_weighted')
cv_recall = cross_val_score(best_knn, X, y, cv=5, scoring='recall_weighted')
cv_f1 = cross_val_score(best_knn, X, y, cv=5, scoring='f1_weighted')
